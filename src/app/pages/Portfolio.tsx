...
export function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1606868305342-c2ec6012cf48?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBlY29tbWVyY2UlMjB3ZWJzaXRlJTIwZGlzcGxheXxlbnwxfHx8fDE3NzQ3Njc0MTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
        ...
        <section className="max-w-4xl mx-auto text-center mt-32">
          ...
          >
            <h2 className="text-4xl lg:text-5xl mb-6">
              Ready to build your <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">project?</span>
            </h2>
